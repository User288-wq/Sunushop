        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              value={product.title}
              onChange={handleChange}
              placeholder="ex: Sac à dos en cuir"
              className="input"
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <label
                ...
                className="px-4 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-green-500 transition"
              >
                📁 Choisir des images
              </label>
